...
int main(void)
{
    ...
    {
        // If 'x' is not less than 'y' and not greater than 'y', it must be equal to 'y'.
...
// If neither of the above conditions is met, it means 'x' is equal to 'y,' and it prints "x is equal to y."
